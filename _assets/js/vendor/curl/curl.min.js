...
l,w);return function(){c.removeEventListener(h,l,w)}}:function(c,h){c.attachEvent("on"+h,l);return function(){c.detachEvent(h,l)}};k&&!l()&&(c=[y(v,"load"),y(k,"readystatechange"),y(v,"DOMContentLoaded")],h=setTimeout(D,B));define("curl/domReady",function(){function c(e){u?e():E.push(e)}c.then=c;c.amd=t;return c})})(this,this.document);define("domReady",["curl/domReady"],function(v){return{load:function(k,x,l){v(l)}}});
